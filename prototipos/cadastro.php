        ...
        <div class="layout-container flex h-full grow flex-col">
            ...
            <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#e7eff3] dark:border-b-background-dark/20 px-4 sm:px-10 py-3 fixed top-0 left-0 right-0 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-sm z-50">
                ...
                <div class="hidden md:flex flex-1 justify-end gap-8">
                    ...
                    <button onclick="abrir_login()" class="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-primary text-white text-sm font-bold leading-normal tracking-[0.015em] hover:bg-primary/90 transition-colors">
            ...
            <form
                ...
                <div class="flex flex-col justify-around items-center w-full h-full">
                    ...
                    <button
                        ...
                        class="w-full h-[40px] mt-2 rounded-md bg-primary text-white text-[1.2rem] cursor-pointer hover:opacity-90 transition">
                        Olá
                    </button>
                </div>
            </form>
            ...
            <form id="login" method="post" class="hidden flex-col fixed items-center w-[300px] h-[350px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white p-10 rounded-xl shadow-[0_0_30px_var(--primary)] z-10">
                ...
                <div class="flex flex-col justify-around items-center w-full h-full ">
                    ...
                    <button type="submit" name="submit_login" class="w-full h-[40px] mt-2 rounded-md bg-primary text-white text-[1.2rem] cursor-pointer hover:opacity-90 transition">
                        Oi
                    </button>

                    <button onclick="abrir_cadastro()" type="button" class="w-full h-[40px] mt-2 rounded-md bg-gray-300 text-black text-[1.2rem] cursor-pointer hover:opacity-90 transition">
                        cadastrar
                    </button>
