        ...
        <div class="layout-container flex h-full grow flex-col">
            <div class="flex flex-1 justify-center">
                <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
                    <!-- TopNavBar -->
                    <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-gray-200 dark:border-gray-700 px-10 py-5">
                        ...
                        <!-- <div class="flex flex-1 justify-end gap-4 items-center">
                            <a href="../front/cadastro.php" class="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-primary text-slate-50 text-sm font-bold leading-normal tracking-[0.015em] hover:bg-primary/90 transition-colors">
                    ...
                    <main class="px-4 md:px-10 py-5">
                        ...
                        <div class="flex flex-wrap justify-between gap-3 p-4">
                            <p class="text-gray-900 dark:text-white text-4xl font-black leading-tight tracking-[-0.033em] min-w-72">
                                Bem-vindo(a), <?php echo $_SESSION['nome']; ?>! Escolha a clínica para iniciar seu agendamento.
                            </p>
                        </div>
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 flex flex-col">
                                ...
                                <div class="p-6 flex flex-col flex-grow">
                                    ...
                                    <div class="mt-auto pt-4">
                                        <a href="agendamento.php" class="w-full flex items-center justify-center rounded-lg h-10 px-4 bg-primary/20 text-primary dark:bg-primary/30 dark:text-white text-sm font-bold hover:bg-primary/30 dark:hover:bg-primary/40 transition-colors">Agendar Agora</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Clinic Card 2 -->
